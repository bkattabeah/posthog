...
export interface DestinationFieldChangeCtx {
...
export interface DestinationDefinition {
    ...
    defaults: (ctx: { featureFlags: FeatureFlagsSet }) => Record<string, any>
    ...
    // Optional hook invoked from the form's setConfigurationValue listener for destination-specific side effects.
    onFieldChange?: (field: string, value: any, ctx: DestinationFieldChangeCtx) => void | Promise<void>
