...
from posthog.temporal.session_replay.session_summary_group import SESSION_SUMMARY_GROUP_WORKFLOWS
        ...
        with self.execute_test_environment(
            ...
            async with await WorkflowEnvironment.start_time_skipping() as activity_environment:
                async with Worker(
                    ...
                    workflows=[*AI_WORKFLOWS, *SESSION_SUMMARY_WORKFLOWS, *SESSION_SUMMARY_GROUP_WORKFLOWS],
                    activities=[
                        check_summary_exists_activity,
                        get_llm_single_session_summary_activity,
                        extract_session_group_patterns_activity,
