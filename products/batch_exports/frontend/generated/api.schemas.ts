...
export type DatabricksDestinationConfigApiType =
    (typeof DatabricksDestinationConfigApiType)[keyof typeof DatabricksDestinationConfigApiType]

export const DatabricksDestinationConfigApiType = {
    Databricks: 'Databricks',
} as const
...
export interface DatabricksDestinationConfigApi {
    ...
    type: DatabricksDestinationConfigApiType
}
...
export type AzureBlobDestinationConfigApiType =
    (typeof AzureBlobDestinationConfigApiType)[keyof typeof AzureBlobDestinationConfigApiType]

export const AzureBlobDestinationConfigApiType = {
    AzureBlob: 'AzureBlob',
} as const
