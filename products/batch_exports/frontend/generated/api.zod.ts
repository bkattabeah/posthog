...
export const BatchExportsBackfillsCreateBody = /* @__PURE__ */ zod.object({
    start_at: zod.iso.datetime({ offset: true }).nullish().describe('The start of the data interval.'),
    end_at: zod.iso.datetime({ offset: true }).nullish().describe('The end of the data interval.'),
    status: zod
        .enum([
            'Cancelled',
            'Completed',
